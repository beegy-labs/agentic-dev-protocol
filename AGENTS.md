...
> **Customization Guide**: `docs/llm/policies/agents-customization.md`

This section is **safe to edit** in each project. Add project-specific rules, tech stack, compliance requirements, etc.
...
**Note**: Remove these examples and add your actual project-specific content.
